...
`;
	...
	*/
	const getStableFeatures = () => ({
		...
		'Firefox': {
			version: 92,
			windowKeys: `undefined, globalThis, Array, Boolean, JSON, Date, Math, Number, String, RegExp, Error, InternalError, AggregateError, EvalError, RangeError, ReferenceError, SyntaxError, TypeError, URIError, ArrayBuffer, Int8Array, Uint8Array, Int16Array, Uint16Array, Int32Array, Uint32Array, Float32Array, Float64Array, Uint8ClampedArray, BigInt64Array, BigUint64Array, BigInt, Proxy, WeakMap, Set, DataView, Symbol, Intl, Reflect, WeakSet, Atomics, Promise, ReadableStream, ByteLengthQueuingStrategy, CountQueuingStrategy, WebAssembly, FinalizationRegistry, WeakRef, NaN, Infinity, isNaN, isFinite, parseFloat, parseInt, escape, unescape, decodeURI, encodeURI, decodeURIComponent, encodeURIComponent, FileList, FileSystemDirectoryReader, Range, ClipboardEvent, HTMLQuoteElement, TextEncoder, WebGLQuery, HTMLMarqueeElement, ValidityState, SVGFEBlendElement, SVGFEGaussianBlurElement, Notification, VRDisplay, MediaKeyError, SVGAnimatedEnumeration, SVGGradientElement, HTMLTimeElement, MediaKeys, StereoPannerNode, ProcessingInstruction, SVGLineElement, SVGAnimatedLengthList, FontFaceSetLoadEvent, CSSMozDocumentRule, WebGLUniformLocation, SVGPolylineElement, IDBTransaction, AudioParamMap, HTMLStyleElement, HTMLMapElement, RTCRtpReceiver, PopupBlockedEvent, AuthenticatorResponse, HTMLCanvasElement, Selection, CSS, PerformanceEntry, DOMRequest, SVGFEImageElement, PerformanceObserver, TextDecoder, U2F, FileSystemFileEntry, RTCDataChannel, InputEvent, HTMLFrameElement, TreeWalker, MessageEvent, URL, ScriptProcessorNode, SVGMPathElement, HTMLBaseElement, SVGTextContentElement, BlobEvent, GainNode, DOMStringMap, mozRTCIceCandidate, Comment, MediaSession, WebGLRenderbuffer, MediaQueryList, OfflineAudioCompletionEvent, DeviceOrientationEvent, ServiceWorkerContainer, MediaElementAudioSourceNode, CloseEvent, VRDisplayCapabilities, SVGFEFloodElement, Navigator, SVGFEFuncBElement, HTMLEmbedElement, CSSStyleDeclaration, ResizeObserverSize, HTMLFrameSetElement, Clipboard, SVGForeignObjectElement, HTMLTableCaptionElement, MediaStreamEvent, SVGRectElement, HTMLImageElement, PushSubscription, IDBObjectStore, WebGLRenderingContext, RadioNodeList, PaintRequestList, AnimationPlaybackEvent, SpeechSynthesisErrorEvent, HTMLElement, DOMRect, MediaStream, HTMLDirectoryElement, OfflineResourceList, SVGComponentTransferFunctionElement, SVGFESpotLightElement, MediaQueryListEvent, SVGSymbolElement, WebGLTransformFeedback, HTMLSpanElement, SourceBufferList, IntersectionObserverEntry, SVGMetadataElement, SVGAnimateElement, SVGUnitTypes, WebGLTexture, MimeType, MediaKeyMessageEvent, CSSImportRule, RTCDataChannelEvent, SVGAnimateMotionElement, SVGDefsElement, CSSFontFaceRule, HTMLParamElement, DataTransfer, BeforeUnloadEvent, HTMLAreaElement, WebGLActiveInfo, DOMPointReadOnly, SVGFEColorMatrixElement, BarProp, DelayNode, MediaRecorderErrorEvent, RTCTrackEvent, OscillatorNode, AbortSignal, AudioWorkletNode, ServiceWorkerRegistration, SVGTransformList, HTMLOptionsCollection, VREyeParameters, HTMLDivElement, FontFace, FileSystem, KeyframeEffect, CompositionEvent, SVGStopElement, CSSStyleSheet, SpeechSynthesis, MimeTypeArray, MediaKeyStatusMap, MediaStreamAudioSourceNode, VRFrameData, TimeEvent, IDBOpenDBRequest, DOMTokenList, SubmitEvent, SVGPointList, HTMLObjectElement, SVGAnimatedTransformList, Element, HTMLAllCollection, SVGMaskElement, DragEvent, SVGPoint, IDBFactory, SVGPreserveAspectRatio, StyleSheetList, HTMLTitleElement, DeviceMotionEvent, HTMLMediaElement, PerformanceResourceTiming, IDBCursorWithValue, HTMLCollection, SecurityPolicyViolationEvent, WebGLProgram, Directory, GeolocationPositionError, MediaStreamTrackEvent, ResizeObserver, PromiseRejectionEvent, HTMLProgressElement, Crypto, XSLTProcessor, RTCRtpTransceiver, AnimationEvent, Cache, AbortController, HTMLButtonElement, AudioNode, IDBFileRequest, SVGPatternElement, HTMLTableColElement, SpeechSynthesisUtterance, SVGFETileElement, HTMLTemplateElement, Screen, HTMLFontElement, SVGTextPositioningElement, SVGTransform, IDBRequest, SVGAnimateTransformElement, AnalyserNode, WebGLShaderPrecisionFormat, TextTrackCue, SVGFEDiffuseLightingElement, WheelEvent, Permissions, AudioProcessingEvent, ImageData, SVGAnimatedLength, AudioScheduledSourceNode, DOMMatrixReadOnly, HTMLOptGroupElement, SVGFEMorphologyElement, CSSStyleRule, PerformanceMark, SVGUseElement, HTMLDataElement, TextTrackList, HTMLAnchorElement, SVGFEComponentTransferElement, SVGStyleElement, SpeechSynthesisEvent, GamepadHapticActuator, CSSKeyframeRule, MediaKeySystemAccess, FormData, VTTCue, TextTrackCueList, HTMLHeadElement, SVGFEMergeNodeElement, PerformanceNavigation, SVGFECompositeElement, RTCCertificate, RTCDTMFToneChangeEvent, HTMLTableRowElement, HTMLLinkElement, FileSystemEntry, MutationEvent, XMLHttpRequest, TransitionEvent, SVGSVGElement, SVGLengthList, SVGTSpanElement, CharacterData, SVGFilterElement, Headers, DocumentFragment, SVGEllipseElement, AnimationEffect, HTMLPictureElement, Request, StorageManager, DOMParser, CSSKeyframesRule, PushSubscriptionOptions, FontFaceSet, HTMLLegendElement, MutationObserver, HTMLUListElement, PeriodicWave, HTMLFormElement, SVGNumberList, RTCStatsReport, CSSMediaRule, WebSocket, OfflineAudioContext, SharedWorker, FileReader, TextMetrics, VTTRegion, XMLHttpRequestEventTarget, XPathResult, SVGTitleElement, PerformanceMeasure, FileSystemDirectoryEntry, BroadcastChannel, SpeechSynthesisVoice, MediaRecorder, HTMLMenuElement, IdleDeadline, Path2D, PerformanceObserverEntryList, VRDisplayEvent, HTMLSelectElement, PublicKeyCredential, AbstractRange, mozRTCPeerConnection, CryptoKey, PaintRequest, WebGLFramebuffer, URLSearchParams, SVGScriptElement, MathMLElement, VRPose, console, DocumentTimeline, HTMLHeadingElement, CSSTransition, HTMLUnknownElement, CSSCounterStyleRule, SVGGElement, HTMLDataListElement, Audio, SVGMatrix, WaveShaperNode, Gamepad, SVGFETurbulenceElement, ShadowRoot, HTMLSlotElement, HTMLSourceElement, IDBDatabase, StorageEvent, HTMLAudioElement, PerformanceEventTiming, MediaCapabilitiesInfo, IDBIndex, RTCDtlsTransport, Option, NodeIterator, Worklet, SVGSwitchElement, XPathExpression, CanvasRenderingContext2D, MediaDevices, SVGFEMergeElement, RTCDTMFSender, ServiceWorker, AudioContext, SVGTextElement, SVGFEFuncGElement, ImageBitmapRenderingContext, BiquadFilterNode, FormDataEvent, HTMLTextAreaElement, HTMLOutputElement, ProgressEvent, GeolocationPosition, RTCSessionDescription, HTMLHtmlElement, Geolocation, SVGAnimationElement, WebGL2RenderingContext, XMLHttpRequestUpload, MessagePort, Attr, PageTransitionEvent, HTMLTableElement, mozRTCSessionDescription, XMLSerializer, HashChangeEvent, CSSAnimation, CSSPageRule, WebKitCSSMatrix, History, Worker, RTCIceCandidate, CredentialsContainer, GamepadEvent, MediaList, GamepadPose, CustomEvent, WebGLBuffer, SVGFEDistantLightElement, SVGFEOffsetElement, HTMLOptionElement, HTMLFormControlsCollection, PerformanceTiming, SVGNumber, SVGPathSegList, HTMLHRElement, AudioListener, IntersectionObserver, SVGStringList, HTMLTableSectionElement, KeyboardEvent, Image, SVGAnimatedAngle, HTMLMetaElement, BaseAudioContext, ConvolverNode, SVGRect, MutationRecord, SVGFEFuncRElement, MediaStreamTrackAudioSourceNode, AuthenticatorAttestationResponse, MediaCapabilities, SVGImageElement, VRFieldOfView, DOMPoint, XPathEvaluator, CSSSupportsRule, DOMRectReadOnly, MediaEncryptedEvent, SVGGraphicsElement, Storage, SVGClipPathElement, HTMLInputElement, NamedNodeMap, AudioBufferSourceNode, AudioParam, AudioDestinationNode, IDBFileHandle, IIRFilterNode, Plugin, SVGGeometryElement, SVGElement, CDATASection, ErrorEvent, ResizeObserverEntry, CaretPosition, TimeRanges, SVGFESpecularLightingElement, SVGAnimatedPreserveAspectRatio, SVGViewElement, PerformancePaintTiming, HTMLIFrameElement, SVGDescElement, SVGLinearGradientElement, HTMLFieldSetElement, SVGAElement, ChannelMergerNode, RTCPeerConnectionIceEvent, StaticRange, HTMLBRElement, SVGCircleElement, MouseEvent, VideoPlaybackQuality, WebGLShader, PushManager, HTMLParagraphElement, DOMException, HTMLTableCellElement, VisualViewport, StyleSheet, File, DocumentType, CanvasCaptureMediaStream, Credential, SVGTextPathElement, WebGLContextEvent, PointerEvent, ScrollAreaEvent, PopStateEvent, PerformanceServerTiming, CSSNamespaceRule, SourceBuffer, SVGFEDropShadowElement, MediaSource, SVGFEConvolveMatrixElement, MediaStreamTrack, SVGFEFuncAElement, PermissionStatus, HTMLTrackElement, HTMLMeterElement, MediaKeySession, CSSRule, DataTransferItem, DynamicsCompressorNode, SVGLength, IDBCursor, DataTransferItemList, SVGAnimatedBoolean, PluginArray, ChannelSplitterNode, HTMLDListElement, MessageChannel, MediaDeviceInfo, WebGLSync, Text, SVGSetElement, SVGAnimatedInteger, SVGFEPointLightElement, VRStageParameters, SVGFEDisplacementMapElement, EventSource, GamepadButton, DOMMatrix, HTMLDetailsElement, CacheStorage, WebGLVertexArrayObject, NodeFilter, MediaStreamAudioDestinationNode, SVGAnimatedNumber, SVGRadialGradientElement, FocusEvent, DOMQuad, CustomElementRegistry, SVGAnimatedRect, IDBMutableFile, CanvasGradient, AudioWorklet, PannerNode, IDBVersionChangeEvent, ImageBitmap, SVGPolygonElement, HTMLBodyElement, IDBKeyRange, Animation, RTCRtpSender, DOMStringList, AuthenticatorAssertionResponse, TrackEvent, ConstantSourceNode, MediaMetadata, WebGLSampler, UIEvent, CSSFontFeatureValuesRule, DOMRectList, GeolocationCoordinates, CSSConditionRule, HTMLLIElement, KeyEvent, HTMLPreElement, CSSGroupingRule, SubtleCrypto, ScreenOrientation, DOMImplementation, MouseScrollEvent, XMLDocument, AnimationTimeline, webkitURL, HTMLVideoElement, SVGAngle, SVGAnimatedNumberList, HTMLModElement, HTMLLabelElement, CSS2Properties, RTCPeerConnection, NodeList, CSSRuleList, AudioBuffer, Blob, HTMLScriptElement, MediaError, SVGMarkerElement, Location, HTMLOListElement, SVGPathElement, SVGAnimatedString, TextTrack, CanvasPattern, Response, Function, Object, eval, EventTarget, Window, close, stop, focus, blur, open, alert, confirm, prompt, print, postMessage, captureEvents, releaseEvents, getSelection, getComputedStyle, matchMedia, moveTo, moveBy, resizeTo, resizeBy, scroll, scrollTo, scrollBy, requestAnimationFrame, cancelAnimationFrame, getDefaultComputedStyle, scrollByLines, scrollByPages, sizeToContent, updateCommands, find, dump, setResizable, requestIdleCallback, cancelIdleCallback, btoa, atob, setTimeout, clearTimeout, setInterval, clearInterval, queueMicrotask, createImageBitmap, fetch, self, name, history, customElements, locationbar, menubar, personalbar, scrollbars, statusbar, toolbar, status, closed, event, frames, length, opener, parent, frameElement, navigator, clientInformation, external, applicationCache, screen, innerWidth, innerHeight, scrollX, pageXOffset, scrollY, pageYOffset, screenLeft, screenTop, screenX, screenY, outerWidth, outerHeight, performance, mozInnerScreenX, mozInnerScreenY, devicePixelRatio, scrollMaxX, scrollMaxY, fullScreen, ondevicemotion, ondeviceorientation, onabsolutedeviceorientation, content, InstallTrigger, sidebar, onvrdisplayconnect, onvrdisplaydisconnect, onvrdisplayactivate, onvrdisplaydeactivate, onvrdisplaypresentchange, visualViewport, crypto, onabort, onblur, onfocus, onauxclick, onbeforeinput, oncanplay, oncanplaythrough, onchange, onclick, onclose, oncontextmenu, oncuechange, ondblclick, ondrag, ondragend, ondragenter, ondragexit, ondragleave, ondragover, ondragstart, ondrop, ondurationchange, onemptied, onended, onformdata, oninput, oninvalid, onkeydown, onkeypress, onkeyup, onload, onloadeddata, onloadedmetadata, onloadend, onloadstart, onmousedown, onmouseenter, onmouseleave, onmousemove, onmouseout, onmouseover, onmouseup, onwheel, onpause, onplay, onplaying, onprogress, onratechange, onreset, onresize, onscroll, onseeked, onseeking, onselect, onstalled, onsubmit, onsuspend, ontimeupdate, onvolumechange, onwaiting, onselectstart, onselectionchange, ontoggle, onpointercancel, onpointerdown, onpointerup, onpointermove, onpointerout, onpointerover, onpointerenter, onpointerleave, ongotpointercapture, onlostpointercapture, onmozfullscreenchange, onmozfullscreenerror, onanimationcancel, onanimationend, onanimationiteration, onanimationstart, ontransitioncancel, ontransitionend, ontransitionrun, ontransitionstart, onwebkitanimationend, onwebkitanimationiteration, onwebkitanimationstart, onwebkittransitionend, u2f, onerror, speechSynthesis, onafterprint, onbeforeprint, onbeforeunload, onhashchange, onlanguagechange, onmessage, onmessageerror, onoffline, ononline, onpagehide, onpageshow, onpopstate, onrejectionhandled, onstorage, onunhandledrejection, onunload, ongamepadconnected, ongamepaddisconnected, localStorage, origin, crossOriginIsolated, isSecureContext, indexedDB, caches, sessionStorage, window, document, location, top, netscape, Node, Document, HTMLDocument, EventCounts, Map, Event`,

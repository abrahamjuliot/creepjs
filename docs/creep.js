...
`;
	...
	*/
	const getStableFeatures = () => ({
		...
		'Firefox': {
			version: 101,
			windowKeys: `undefined, globalThis, Array, Boolean, JSON, Date, Math, Number, String, RegExp, Error, InternalError, AggregateError, EvalError, RangeError, ReferenceError, SyntaxError, TypeError, URIError, ArrayBuffer, Int8Array, Uint8Array, Int16Array, Uint16Array, Int32Array, Uint32Array, Float32Array, Float64Array, Uint8ClampedArray, BigInt64Array, BigUint64Array, BigInt, Proxy, WeakMap, Set, DataView, Symbol, Intl, Reflect, WeakSet, Atomics, Promise, WebAssembly, FinalizationRegistry, WeakRef, NaN, Infinity, isNaN, isFinite, parseFloat, parseInt, escape, unescape, decodeURI, encodeURI, decodeURIComponent, encodeURIComponent, PermissionStatus, UIEvent, IDBFileHandle, CSSStyleDeclaration, SVGFilterElement, CanvasGradient, SVGFEDisplacementMapElement, RTCIceCandidate, StorageEvent, SVGUnitTypes, FontFaceSet, MediaKeyMessageEvent, SVGGraphicsElement, CSS, CSSConditionRule, SVGAnimatedEnumeration, MediaDevices, NavigationPreloadManager, CSSKeyframeRule, ServiceWorkerContainer, HTMLIFrameElement, FontFaceSetLoadEvent, GamepadPose, SpeechSynthesisUtterance, HashChangeEvent, PerformanceObserverEntryList, IDBCursorWithValue, HTMLLegendElement, HTMLPictureElement, ReadableStream, SVGFEFuncGElement, PerformanceObserver, AbortSignal, CSSRuleList, WebGLTexture, ChannelSplitterNode, ReadableStreamDefaultReader, IDBTransaction, SVGAnimateTransformElement, MediaStreamTrack, HTMLScriptElement, Storage, DataTransferItemList, GamepadEvent, RTCPeerConnection, HTMLHeadElement, MediaKeys, File, IDBVersionChangeEvent, SVGStringList, WebGLQuery, HTMLCanvasElement, OfflineResourceList, CSSFontFaceRule, SVGRect, MediaKeySession, RTCDataChannelEvent, FileSystemFileEntry, PopupBlockedEvent, SVGAnimatedPreserveAspectRatio, SpeechSynthesisEvent, DOMStringList, MediaStreamTrackEvent, HTMLTrackElement, SVGImageElement, GeolocationPosition, SVGAnimationElement, mozRTCSessionDescription, PromiseRejectionEvent, SVGMatrix, WebGLTransformFeedback, SVGEllipseElement, StorageManager, Audio, SVGGeometryElement, ImageData, SVGRectElement, SVGNumber, SVGTextPositioningElement, CSSMediaRule, AudioContext, HTMLVideoElement, SVGPolygonElement, CryptoKey, URLSearchParams, InputEvent, HTMLMetaElement, IIRFilterNode, ImageBitmapRenderingContext, HTMLMapElement, DOMTokenList, DOMStringMap, MediaRecorder, SVGScriptElement, WheelEvent, HTMLTableCaptionElement, SVGAnimateMotionElement, MimeType, Path2D, SVGFEImageElement, HTMLBaseElement, SVGPointList, SourceBufferList, MediaKeySystemAccess, HTMLAllCollection, TextDecoder, XPathEvaluator, SVGLineElement, WebGLUniformLocation, WebGLRenderingContext, SpeechSynthesisVoice, GamepadHapticActuator, PublicKeyCredential, SVGGradientElement, ScriptProcessorNode, SVGFEComponentTransferElement, SVGAnimatedTransformList, SVGUseElement, PopStateEvent, PannerNode, CSSFontFeatureValuesRule, Directory, Blob, SVGFEMergeElement, SVGAnimatedAngle, CustomEvent, SVGAnimatedNumberList, XMLHttpRequestEventTarget, HTMLFormControlsCollection, SVGPreserveAspectRatio, GamepadButton, HTMLCollection, VTTRegion, FileSystemEntry, NodeList, ProcessingInstruction, MediaRecorderErrorEvent, CSSKeyframesRule, HTMLMediaElement, RTCDataChannel, FormData, AnimationTimeline, WebGLVertexArrayObject, AbortController, AuthenticatorResponse, XMLSerializer, NamedNodeMap, MediaKeyError, XMLHttpRequest, CredentialsContainer, TimeRanges, ServiceWorker, CloseEvent, ImageBitmap, AudioBuffer, HTMLDataElement, KeyboardEvent, PushSubscription, OscillatorNode, RTCDTMFToneChangeEvent, HTMLDataListElement, SVGForeignObjectElement, MimeTypeArray, MutationRecord, SVGFEFuncRElement, IDBKeyRange, SVGAnimatedString, IDBIndex, FileSystemDirectoryEntry, HTMLAreaElement, HTMLMenuElement, HTMLParagraphElement, FocusEvent, WebGLContextEvent, HTMLSelectElement, SVGFEDropShadowElement, WebGLShaderPrecisionFormat, AudioScheduledSourceNode, SVGSVGElement, HTMLQuoteElement, SVGStyleElement, HTMLProgressElement, SVGTransform, HTMLLIElement, Request, DOMException, SVGAnimatedRect, HTMLOutputElement, BiquadFilterNode, HTMLInputElement, CSSTransition, ValidityState, IntersectionObserverEntry, HTMLDetailsElement, SVGFEGaussianBlurElement, DOMParser, RTCRtpReceiver, WebGLProgram, AuthenticatorAssertionResponse, SVGFEFuncAElement, PageTransitionEvent, SVGTitleElement, WebSocket, ElementInternals, GeolocationPositionError, PerformanceServerTiming, HTMLFontElement, SVGTextPathElement, DOMMatrixReadOnly, OfflineAudioCompletionEvent, AudioDestinationNode, Worker, MessageEvent, Permissions, SVGAnimatedBoolean, HTMLHeadingElement, MediaElementAudioSourceNode, SVGTextContentElement, PushManager, OfflineAudioContext, StereoPannerNode, MediaList, RadioNodeList, IntersectionObserver, MouseEvent, MediaSource, HTMLPreElement, DOMRequest, Screen, HTMLOListElement, WaveShaperNode, PerformancePaintTiming, SVGRadialGradientElement, MediaStreamEvent, SVGCircleElement, Animation, XMLDocument, HTMLDialogElement, Attr, IDBOpenDBRequest, HTMLTitleElement, Range, HTMLBodyElement, MediaStreamAudioDestinationNode, RTCPeerConnectionIceEvent, MediaStream, SVGFEFloodElement, HTMLObjectElement, HTMLSlotElement, GeolocationCoordinates, WebGLRenderbuffer, KeyframeEffect, HTMLOptionsCollection, CSSNamespaceRule, TextMetrics, HTMLSpanElement, StyleSheetList, SVGDefsElement, DeviceOrientationEvent, mozRTCIceCandidate, BaseAudioContext, XPathResult, SVGLengthList, StaticRange, CSSMozDocumentRule, RTCSessionDescription, webkitURL, ConstantSourceNode, CSSStyleRule, MutationEvent, DocumentType, HTMLTableSectionElement, AnimationEffect, TimeEvent, SVGFEDiffuseLightingElement, CSSPageRule, PeriodicWave, SVGPathElement, DOMImplementation, WebGLActiveInfo, Gamepad, Worklet, NodeFilter, TextTrack, HTMLTableColElement, TreeWalker, PerformanceTiming, AnimationPlaybackEvent, HTMLTemplateElement, RTCRtpSender, SVGFEMergeNodeElement, IdleDeadline, Element, SourceBuffer, DeviceMotionEvent, MutationObserver, RTCRtpTransceiver, HTMLImageElement, SubmitEvent, MediaQueryList, CDATASection, MediaQueryListEvent, SVGFEBlendElement, PerformanceMark, HTMLFieldSetElement, SVGFEDistantLightElement, HTMLElement, HTMLParamElement, MediaCapabilities, ChannelMergerNode, Navigator, SharedWorker, DelayNode, AudioBufferSourceNode, WebGL2RenderingContext, SVGLength, SVGFEOffsetElement, FontFace, PaintRequest, SpeechSynthesis, XPathExpression, IDBRequest, WritableStreamDefaultWriter, SVGLinearGradientElement, RTCDTMFSender, MediaError, HTMLDirectoryElement, MouseScrollEvent, MediaMetadata, SVGGElement, WritableStreamDefaultController, SVGFETurbulenceElement, IDBCursor, CanvasPattern, WebGLShader, SVGFESpecularLightingElement, PerformanceMeasure, Location, DataTransferItem, VisualViewport, DOMMatrix, SVGFEConvolveMatrixElement, AudioProcessingEvent, SubtleCrypto, SVGAnimatedInteger, DataTransfer, mozRTCPeerConnection, WebGLSync, SVGSymbolElement, HTMLEmbedElement, SVGFESpotLightElement, ResizeObserver, SVGMarkerElement, SVGFEFuncBElement, HTMLMarqueeElement, PluginArray, FileSystemDirectoryReader, CSSGroupingRule, HTMLStyleElement, HTMLTextAreaElement, MediaKeyStatusMap, SVGTextElement, ShadowRoot, TransitionEvent, MessageChannel, NodeIterator, CSSLayerBlockRule, WebKitCSSMatrix, Plugin, ScrollAreaEvent, Option, HTMLAnchorElement, PointerEvent, SVGMPathElement, SVGFEColorMatrixElement, TextTrackCueList, AudioParamMap, Clipboard, Response, MediaStreamAudioSourceNode, StyleSheet, KeyEvent, TrackEvent, DOMPoint, HTMLHtmlElement, SVGViewElement, HTMLLinkElement, CSSLayerStatementRule, HTMLFormElement, SVGFETileElement, MediaEncryptedEvent, IDBFileRequest, HTMLMeterElement, CSSAnimation, SVGDescElement, AudioListener, Geolocation, SVGMetadataElement, Image, HTMLHRElement, MediaSession, HTMLFrameSetElement, HTMLButtonElement, BarProp, SVGClipPathElement, ScreenOrientation, MathMLElement, SVGFEPointLightElement, HTMLOptionElement, XSLTProcessor, CSSStyleSheet, SVGSetElement, SVGFECompositeElement, DOMPointReadOnly, SVGAElement, History, DragEvent, AudioWorkletNode, MediaDeviceInfo, HTMLUnknownElement, SVGComponentTransferFunctionElement, HTMLLabelElement, HTMLOptGroupElement, Lock, CompositionEvent, AuthenticatorAttestationResponse, HTMLUListElement, HTMLTimeElement, IDBObjectStore, PerformanceEntry, ProgressEvent, Notification, XMLHttpRequestUpload, SpeechSynthesisErrorEvent, ResizeObserverEntry, TextTrackCue, DOMQuad, HTMLTableRowElement, CSS2Properties, TextEncoder, HTMLTableCellElement, Credential, CanvasCaptureMediaStream, RTCStatsReport, CSSRule, AudioParam, LockManager, SVGAnimatedLength, SVGStopElement, ByteLengthQueuingStrategy, Cache, FileList, IDBDatabase, HTMLAudioElement, HTMLDListElement, CacheStorage, HTMLFrameElement, SVGAnimateElement, SVGSwitchElement, BeforeUnloadEvent, RTCCertificate, HTMLDivElement, PushSubscriptionOptions, SVGAngle, PaintRequestList, PerformanceEventTiming, SVGPolylineElement, MediaCapabilitiesInfo, AnimationEvent, FormDataEvent, DOMRect, FileSystem, RTCTrackEvent, DOMRectList, WritableStream, PerformanceNavigation, SVGMaskElement, Text, ServiceWorkerRegistration, TextTrackList, SVGAnimatedNumber, Headers, ConvolverNode, MediaStreamTrackAudioSourceNode, URL, CharacterData, AudioWorklet, DocumentTimeline, HTMLModElement, SVGTSpanElement, PerformanceResourceTiming, CSSCounterStyleRule, ClipboardEvent, BroadcastChannel, SVGPatternElement, AnalyserNode, SVGTransformList, SVGElement, IDBFactory, DOMRectReadOnly, U2F, GainNode, WebGLSampler, WebGLBuffer, ErrorEvent, Selection, DocumentFragment, SecurityPolicyViolationEvent, Comment, HTMLBRElement, SVGAnimatedLengthList, SVGPoint, SVGFEMorphologyElement, ReadableStreamDefaultController, MessagePort, BlobEvent, IDBMutableFile, EventSource, CustomElementRegistry, AudioNode, CountQueuingStrategy, FileReader, WebGLFramebuffer, CSSSupportsRule, VideoPlaybackQuality, CSSImportRule, Crypto, RTCDtlsTransport, HTMLTableElement, SVGNumberList, CaretPosition, VTTCue, AbstractRange, HTMLSourceElement, CanvasRenderingContext2D, console, ResizeObserverSize, DynamicsCompressorNode, Function, Object, eval, EventTarget, Window, close, stop, focus, blur, open, alert, confirm, prompt, print, postMessage, captureEvents, releaseEvents, getSelection, getComputedStyle, matchMedia, moveTo, moveBy, resizeTo, resizeBy, scroll, scrollTo, scrollBy, getDefaultComputedStyle, scrollByLines, scrollByPages, sizeToContent, updateCommands, find, dump, setResizable, requestIdleCallback, cancelIdleCallback, requestAnimationFrame, cancelAnimationFrame, reportError, btoa, atob, setTimeout, clearTimeout, setInterval, clearInterval, queueMicrotask, createImageBitmap, structuredClone, fetch, self, name, history, customElements, locationbar, menubar, personalbar, scrollbars, statusbar, toolbar, status, closed, event, frames, length, opener, parent, frameElement, navigator, clientInformation, external, applicationCache, screen, innerWidth, innerHeight, scrollX, pageXOffset, scrollY, pageYOffset, screenLeft, screenTop, screenX, screenY, outerWidth, outerHeight, performance, mozInnerScreenX, mozInnerScreenY, devicePixelRatio, scrollMaxX, scrollMaxY, fullScreen, ondevicemotion, ondeviceorientation, onabsolutedeviceorientation, InstallTrigger, sidebar, visualViewport, crypto, onabort, onblur, onfocus, onauxclick, onbeforeinput, oncanplay, oncanplaythrough, onchange, onclick, onclose, oncontextmenu, oncuechange, ondblclick, ondrag, ondragend, ondragenter, ondragexit, ondragleave, ondragover, ondragstart, ondrop, ondurationchange, onemptied, onended, onformdata, oninput, oninvalid, onkeydown, onkeypress, onkeyup, onload, onloadeddata, onloadedmetadata, onloadend, onloadstart, onmousedown, onmouseenter, onmouseleave, onmousemove, onmouseout, onmouseover, onmouseup, onwheel, onpause, onplay, onplaying, onprogress, onratechange, onreset, onresize, onscroll, onsecuritypolicyviolation, onseeked, onseeking, onselect, onslotchange, onstalled, onsubmit, onsuspend, ontimeupdate, onvolumechange, onwaiting, onselectstart, onselectionchange, ontoggle, onpointercancel, onpointerdown, onpointerup, onpointermove, onpointerout, onpointerover, onpointerenter, onpointerleave, ongotpointercapture, onlostpointercapture, onmozfullscreenchange, onmozfullscreenerror, onanimationcancel, onanimationend, onanimationiteration, onanimationstart, ontransitioncancel, ontransitionend, ontransitionrun, ontransitionstart, onwebkitanimationend, onwebkitanimationiteration, onwebkitanimationstart, onwebkittransitionend, u2f, onerror, speechSynthesis, onafterprint, onbeforeprint, onbeforeunload, onhashchange, onlanguagechange, onmessage, onmessageerror, onoffline, ononline, onpagehide, onpageshow, onpopstate, onrejectionhandled, onstorage, onunhandledrejection, onunload, ongamepadconnected, ongamepaddisconnected, localStorage, origin, crossOriginIsolated, isSecureContext, indexedDB, caches, sessionStorage, window, document, location, top, netscape, Node, Document, HTMLDocument, EventCounts, Map, Event`,
	...
	const getEngineMaps = browser => {
		...
		const geckoJS = {
			...
			'101': ['Document.adoptedStyleSheets'],
		};
	...
	const webrtcHTML = (webRTC, { hashMini, note, modal }) => {
		if (!webRTC) {
			return `
	<div class="col-six">

...
`;
	...
	*/
	const getStableFeatures = () => ({
		...
		'Firefox': {
			version: 97,
			windowKeys: `undefined, globalThis, Array, Boolean, JSON, Date, Math, Number, String, RegExp, Error, InternalError, AggregateError, EvalError, RangeError, ReferenceError, SyntaxError, TypeError, URIError, ArrayBuffer, Int8Array, Uint8Array, Int16Array, Uint16Array, Int32Array, Uint32Array, Float32Array, Float64Array, Uint8ClampedArray, BigInt64Array, BigUint64Array, BigInt, Proxy, WeakMap, Set, DataView, Symbol, Intl, Reflect, WeakSet, Atomics, Promise, ReadableStream, ByteLengthQueuingStrategy, CountQueuingStrategy, WebAssembly, FinalizationRegistry, WeakRef, NaN, Infinity, isNaN, isFinite, parseFloat, parseInt, escape, unescape, decodeURI, encodeURI, decodeURIComponent, encodeURIComponent, HTMLFormControlsCollection, Path2D, PerformanceObserver, HTMLPreElement, FileSystemEntry, HTMLHtmlElement, HTMLElement, MutationRecord, SVGForeignObjectElement, HTMLBRElement, SVGFEFuncRElement, Worker, HTMLBaseElement, Attr, MediaDevices, RTCDTMFSender, SVGFEDistantLightElement, SpeechSynthesisErrorEvent, SVGGradientElement, SVGPolylineElement, mozRTCSessionDescription, Credential, Plugin, CustomElementRegistry, SVGViewElement, VisualViewport, DOMException, WheelEvent, SVGAnimateElement, XMLHttpRequest, WebKitCSSMatrix, TextTrackCueList, AnimationPlaybackEvent, PerformanceServerTiming, SVGFEMergeNodeElement, ProcessingInstruction, CSS, CSSMozDocumentRule, SpeechSynthesis, MediaRecorderErrorEvent, PopupBlockedEvent, SVGPathElement, FocusEvent, DOMStringList, XMLHttpRequestUpload, HTMLLabelElement, MouseEvent, PerformancePaintTiming, DeviceOrientationEvent, MutationObserver, U2F, SVGSwitchElement, GeolocationPositionError, CSSLayerBlockRule, SVGAnimatedInteger, FileSystemDirectoryEntry, UIEvent, SVGFETurbulenceElement, CanvasCaptureMediaStream, SVGFEMorphologyElement, DOMRectList, SVGAnimatedString, HTMLParagraphElement, Notification, SVGAnimatedNumber, URLSearchParams, RTCDtlsTransport, Response, SVGSetElement, HTMLOptGroupElement, HTMLMenuElement, SVGAnimationElement, SVGPolygonElement, SVGTransformList, SVGStyleElement, HTMLDListElement, KeyEvent, SVGRadialGradientElement, CSSNamespaceRule, PermissionStatus, MimeType, IDBFactory, NamedNodeMap, HTMLTableCellElement, HTMLTitleElement, HTMLOptionsCollection, XPathExpression, MediaSession, HTMLLIElement, SVGFEFuncAElement, Storage, WebGLActiveInfo, SVGComponentTransferFunctionElement, MediaCapabilitiesInfo, SharedWorker, SVGFEDisplacementMapElement, SourceBuffer, ChannelSplitterNode, ServiceWorker, ChannelMergerNode, RTCDTMFToneChangeEvent, TextTrackList, MimeTypeArray, VideoPlaybackQuality, Gamepad, MediaKeyStatusMap, Crypto, HTMLTableElement, SVGLength, HTMLLegendElement, RTCIceCandidate, HTMLCanvasElement, AbortController, MediaStreamEvent, MediaRecorder, MessagePort, GeolocationCoordinates, SVGAnimatedAngle, MediaCapabilities, SubmitEvent, mozRTCIceCandidate, StorageManager, console, WebGLContextEvent, CryptoKey, HTMLAreaElement, InputEvent, WebGLTransformFeedback, HTMLFontElement, HTMLFrameElement, WebGLRenderingContext, ConstantSourceNode, ResizeObserverSize, IdleDeadline, CSS2Properties, HTMLVideoElement, ProgressEvent, Audio, MediaQueryList, CSSMediaRule, SVGPreserveAspectRatio, DocumentFragment, ImageBitmapRenderingContext, IDBIndex, HTMLDetailsElement, HTMLDataListElement, AudioScheduledSourceNode, SVGFEMergeElement, SVGFEImageElement, RTCCertificate, DOMRectReadOnly, CanvasGradient, SVGPatternElement, WebGLShaderPrecisionFormat, SVGFEFuncGElement, GeolocationPosition, CSSKeyframeRule, IDBTransaction, HTMLSpanElement, AudioWorklet, RTCDataChannel, AudioBufferSourceNode, HTMLImageElement, SVGSVGElement, WebGLSampler, SVGAnimatedLength, SVGNumber, HTMLTableSectionElement, HTMLButtonElement, FileSystem, PageTransitionEvent, SVGAnimatedNumberList, CacheStorage, WebGLUniformLocation, HTMLBodyElement, MouseScrollEvent, Option, ClipboardEvent, ImageBitmap, NodeFilter, HTMLSelectElement, AudioListener, BarProp, CSSRuleList, ShadowRoot, PublicKeyCredential, HTMLCollection, SVGTitleElement, RTCRtpReceiver, CSSLayerStatementRule, MessageEvent, HTMLQuoteElement, HTMLScriptElement, SVGTransform, FontFaceSet, StorageEvent, AudioWorkletNode, DOMMatrix, WebGLTexture, HTMLTemplateElement, Geolocation, MediaKeyMessageEvent, IntersectionObserverEntry, HTMLOListElement, TextTrackCue, Cache, AnimationTimeline, SVGFEDropShadowElement, HashChangeEvent, MessageChannel, WebGLProgram, SVGAnimatedBoolean, MediaEncryptedEvent, HTMLSlotElement, MediaQueryListEvent, DynamicsCompressorNode, PopStateEvent, HTMLPictureElement, SVGGElement, SVGAnimatedTransformList, webkitURL, Element, HTMLLinkElement, SVGFEFuncBElement, SVGMatrix, SVGLengthList, PluginArray, GamepadPose, PerformanceMeasure, Range, HTMLIFrameElement, BiquadFilterNode, HTMLMeterElement, WebGLFramebuffer, XMLSerializer, PerformanceMark, SVGFEPointLightElement, IDBKeyRange, SVGPoint, MediaMetadata, PerformanceEntry, AudioContext, AudioDestinationNode, MediaKeys, TreeWalker, PerformanceNavigation, SubtleCrypto, SVGFESpecularLightingElement, AbortSignal, PannerNode, WebGLQuery, AudioBuffer, SVGFEOffsetElement, SpeechSynthesisUtterance, SVGGeometryElement, CSSFontFaceRule, IDBFileRequest, IIRFilterNode, HTMLAllCollection, WebGLBuffer, CSSStyleSheet, CustomEvent, DataTransferItemList, HTMLObjectElement, OfflineAudioContext, VTTCue, SVGGraphicsElement, SVGFEGaussianBlurElement, CSSConditionRule, SVGFESpotLightElement, SVGAnimatedEnumeration, RTCPeerConnection, CharacterData, AnimationEvent, SecurityPolicyViolationEvent, CompositionEvent, DocumentTimeline, SVGTextPositioningElement, ErrorEvent, ServiceWorkerContainer, Selection, CloseEvent, MediaStreamTrackEvent, MediaStreamAudioDestinationNode, Image, History, HTMLOptionElement, SVGFEDiffuseLightingElement, HTMLEmbedElement, SourceBufferList, RTCPeerConnectionIceEvent, MediaKeySystemAccess, DOMMatrixReadOnly, HTMLTableColElement, TextDecoder, DOMRect, HTMLModElement, CSSSupportsRule, IDBVersionChangeEvent, HTMLDataElement, OfflineResourceList, MediaError, MediaKeySession, VTTRegion, ServiceWorkerRegistration, Lock, MediaStreamTrack, SVGSymbolElement, SVGImageElement, HTMLSourceElement, SVGDefsElement, HTMLOutputElement, MediaStreamAudioSourceNode, NodeList, AnimationEffect, SVGAnimatedRect, HTMLMediaElement, HTMLTimeElement, SVGFETileElement, HTMLUListElement, PerformanceTiming, CSSImportRule, TimeEvent, CSSStyleDeclaration, SVGRect, GainNode, Request, HTMLTextAreaElement, SpeechSynthesisVoice, SVGAnimateMotionElement, SpeechSynthesisEvent, AbstractRange, IDBCursorWithValue, TextEncoder, SVGUnitTypes, WebGLShader, MutationEvent, FileSystemFileEntry, DOMParser, DOMStringMap, AuthenticatorAssertionResponse, MediaKeyError, FormDataEvent, OscillatorNode, GamepadHapticActuator, TransitionEvent, StyleSheet, HTMLHeadElement, GamepadButton, HTMLFormElement, AudioParam, IDBOpenDBRequest, KeyframeEffect, DOMPointReadOnly, KeyboardEvent, BlobEvent, mozRTCPeerConnection, SVGMetadataElement, WebGLSync, IDBDatabase, File, PushManager, PushSubscriptionOptions, RTCTrackEvent, DOMImplementation, PaintRequestList, WebGL2RenderingContext, CaretPosition, RTCRtpSender, FontFaceSetLoadEvent, ElementInternals, SVGScriptElement, SVGFilterElement, Comment, PointerEvent, SVGNumberList, BeforeUnloadEvent, XMLHttpRequestEventTarget, AuthenticatorAttestationResponse, DOMTokenList, FileSystemDirectoryReader, FormData, SVGAElement, WebSocket, StyleSheetList, AudioProcessingEvent, HTMLStyleElement, ResizeObserver, DocumentType, DOMRequest, IDBObjectStore, PerformanceResourceTiming, PerformanceObserverEntryList, SVGEllipseElement, CSSStyleRule, MediaList, SVGAngle, SVGElement, HTMLFrameSetElement, CSSAnimation, ValidityState, MediaElementAudioSourceNode, BaseAudioContext, MediaDeviceInfo, PromiseRejectionEvent, RTCStatsReport, ConvolverNode, SVGDescElement, TrackEvent, IDBRequest, HTMLMapElement, HTMLTrackElement, TimeRanges, HTMLHRElement, HTMLHeadingElement, SVGTextContentElement, SVGFEConvolveMatrixElement, EventSource, SVGMPathElement, SVGFEComponentTransferElement, TextMetrics, AudioParamMap, CSSTransition, HTMLParamElement, DataTransferItem, HTMLTableCaptionElement, Navigator, LockManager, IDBCursor, Permissions, HTMLProgressElement, SVGRectElement, URL, FileReader, StaticRange, SVGCircleElement, HTMLAnchorElement, XPathResult, Animation, ImageData, HTMLMetaElement, SVGAnimatedLengthList, GamepadEvent, FontFace, SVGFECompositeElement, HTMLTableRowElement, DOMPoint, SVGClipPathElement, CSSKeyframesRule, ScriptProcessorNode, SVGFEBlendElement, SVGLineElement, RadioNodeList, AnalyserNode, CSSGroupingRule, Directory, CanvasPattern, RTCRtpTransceiver, OfflineAudioCompletionEvent, SVGLinearGradientElement, StereoPannerNode, FileList, Headers, Worklet, XMLDocument, AudioNode, CDATASection, WebGLRenderbuffer, DataTransfer, CSSPageRule, Blob, SVGStopElement, DOMQuad, IntersectionObserver, WebGLVertexArrayObject, DeviceMotionEvent, Screen, HTMLInputElement, DragEvent, ScrollAreaEvent, AuthenticatorResponse, MediaStreamTrackAudioSourceNode, HTMLUnknownElement, SVGFEColorMatrixElement, CSSRule, MediaSource, CanvasRenderingContext2D, SVGFEFloodElement, HTMLDirectoryElement, HTMLMarqueeElement, SVGMaskElement, Location, SVGUseElement, CredentialsContainer, RTCDataChannelEvent, WaveShaperNode, SVGTSpanElement, SVGPointList, RTCSessionDescription, MediaStream, SVGMarkerElement, IDBMutableFile, PeriodicWave, ResizeObserverEntry, TextTrack, BroadcastChannel, DelayNode, SVGAnimatedPreserveAspectRatio, NodeIterator, XSLTProcessor, SVGAnimateTransformElement, PaintRequest, SVGStringList, ScreenOrientation, Clipboard, IDBFileHandle, HTMLFieldSetElement, SVGTextPathElement, MathMLElement, CSSFontFeatureValuesRule, PushSubscription, XPathEvaluator, HTMLAudioElement, SVGTextElement, CSSCounterStyleRule, PerformanceEventTiming, Text, HTMLDivElement, Function, Object, eval, EventTarget, Window, close, stop, focus, blur, open, alert, confirm, prompt, print, postMessage, captureEvents, releaseEvents, getSelection, getComputedStyle, matchMedia, moveTo, moveBy, resizeTo, resizeBy, scroll, scrollTo, scrollBy, getDefaultComputedStyle, scrollByLines, scrollByPages, sizeToContent, updateCommands, find, dump, setResizable, requestIdleCallback, cancelIdleCallback, requestAnimationFrame, cancelAnimationFrame, reportError, btoa, atob, setTimeout, clearTimeout, setInterval, clearInterval, queueMicrotask, createImageBitmap, structuredClone, fetch, self, name, history, customElements, locationbar, menubar, personalbar, scrollbars, statusbar, toolbar, status, closed, event, frames, length, opener, parent, frameElement, navigator, clientInformation, external, applicationCache, screen, innerWidth, innerHeight, scrollX, pageXOffset, scrollY, pageYOffset, screenLeft, screenTop, screenX, screenY, outerWidth, outerHeight, performance, mozInnerScreenX, mozInnerScreenY, devicePixelRatio, scrollMaxX, scrollMaxY, fullScreen, ondevicemotion, ondeviceorientation, onabsolutedeviceorientation, content, InstallTrigger, sidebar, visualViewport, crypto, onabort, onblur, onfocus, onauxclick, onbeforeinput, oncanplay, oncanplaythrough, onchange, onclick, onclose, oncontextmenu, oncuechange, ondblclick, ondrag, ondragend, ondragenter, ondragexit, ondragleave, ondragover, ondragstart, ondrop, ondurationchange, onemptied, onended, onformdata, oninput, oninvalid, onkeydown, onkeypress, onkeyup, onload, onloadeddata, onloadedmetadata, onloadend, onloadstart, onmousedown, onmouseenter, onmouseleave, onmousemove, onmouseout, onmouseover, onmouseup, onwheel, onpause, onplay, onplaying, onprogress, onratechange, onreset, onresize, onscroll, onsecuritypolicyviolation, onseeked, onseeking, onselect, onslotchange, onstalled, onsubmit, onsuspend, ontimeupdate, onvolumechange, onwaiting, onselectstart, onselectionchange, ontoggle, onpointercancel, onpointerdown, onpointerup, onpointermove, onpointerout, onpointerover, onpointerenter, onpointerleave, ongotpointercapture, onlostpointercapture, onmozfullscreenchange, onmozfullscreenerror, onanimationcancel, onanimationend, onanimationiteration, onanimationstart, ontransitioncancel, ontransitionend, ontransitionrun, ontransitionstart, onwebkitanimationend, onwebkitanimationiteration, onwebkitanimationstart, onwebkittransitionend, u2f, onerror, speechSynthesis, onafterprint, onbeforeprint, onbeforeunload, onhashchange, onlanguagechange, onmessage, onmessageerror, onoffline, ononline, onpagehide, onpageshow, onpopstate, onrejectionhandled, onstorage, onunhandledrejection, onunload, ongamepadconnected, ongamepaddisconnected, localStorage, origin, crossOriginIsolated, isSecureContext, indexedDB, caches, sessionStorage, window, document, location, top, netscape, Node, Document, HTMLDocument, EventCounts, Map, Event`,
	...
	const getEngineMaps = browser => {
		...
		const blinkJS = {
			...
			'99-100': ['Intl.supportedValuesOf', 'Document.oncontextlost', 'Document.oncontextrestored']
		};
		...
		const geckoJS = {
			...
			'92': ['Object.hasOwn'],
			'93-97': ['Intl.supportedValuesOf','Document.onsecuritypolicyviolation','Document.onslotchange']
		};

...
const getEngineMaps = browser => {
	...
	const geckoJS = {
		...
		'92': ['Object.hasOwn'],
		'93-95': ['Intl.supportedValuesOf','Document.onsecuritypolicyviolation','Document.onslotchange']
	}

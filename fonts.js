...
console.log(detect([...fontList, ...extendedFontList,...googleFonts]))
process('Fingerprint complete')

console.log([...fontList, ...extendedFontList,...googleFonts].length)
console.log([...new Set([...fontList, ...extendedFontList,...googleFonts])].length)

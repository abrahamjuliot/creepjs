...
const getEngineMaps = (browser) => {
	...
	const blinkWindow = {
		...
		'107': ['XRCamera'],
		'108': ['ContentVisibilityAutoStateChangeEvent'],
	}
	...
	const blinkJS = {
		...
		'108': ['Document.oncontentvisibilityautostatechange'],
	}

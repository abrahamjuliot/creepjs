...
const getEngineMaps = (browser) => {
	...
	const blinkWindow = {
		...
		'107': ['XRCamera'],
		'108': ['ContentVisibilityAutoStateChangedEvent'],
	}
	...
	const geckoJS = {
		...
		'104-106': ['Array.findLast', 'Array.findLastIndex'],
	}

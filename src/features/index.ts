...
const getEngineMaps = (browser) => {
	...
	const blinkCSS = {
		...
		'104': ['object-view-box'],
		'105-106': ['container-name', 'container-type', 'container'],
	}
